  ...
  return (
    ...
    >
      <div style={{ position: 'relative', width: '398px', height: '34px' }}>
        ...
        >
          <path d="M394 14H226.775C226.756 14.0366 226.737 14.0739 226.717 14.1104C225.209 16.8402 222.999 19.3208 220.213 21.4102C217.427 23.4994 214.12 25.1564 210.48 26.2871C206.841 27.4178 202.94 28 199 28C195.06 28 191.159 27.4178 187.52 26.2871C183.88 25.1564 180.573 23.4994 177.787 21.4102C175.001 19.3208 172.791 16.8402 171.283 14.1104C171.263 14.0739 171.244 14.0366 171.225 14H4V2H394V14Z" fill="white"/>
        </svg>
