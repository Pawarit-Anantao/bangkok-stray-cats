...
export default function AggressivenessSelector({ selectedLevel, onSelect }: AggressivenessSelectorProps) {
  ...
  return (
    <div style={{ marginTop: '24px', width: '100%' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '12px' }}>
        <h2 style={{ fontSize: '20px', fontWeight: 'normal', fontFamily: FONT_VARIABLE, margin: 0 }}>
          ประสบการณ์ความดุ
        </h2>
        <span style={{ fontSize: '11px', color: '#8F8362', fontFamily: FONT_VARIABLE }}>ไม่บังคับ</span>
      </div>
      ...
      <div style={{ 
        ...
        alignItems: 'center', 
        background: '#F7F7F7', // พื้นหลังนวลเหมือน Tags
        padding: '16px 8px',
        borderRadius: '16px',
          ...
          return (
            <button
              ...
              style={{
                ...
                transform: isActive ? 'scale(1.1)' : 'scale(1)', // ขยายใหญ่ขึ้นเมื่อเลือก
              }}
            >
              {/* 🖼️ Icon */}
              <div style={{
