...
const cardFrame: React.CSSProperties = {
  ...
  background: "rgba(13, 48, 103, 0.5)",
  backdropFilter: "blur(16px)",
};
const innerContentFrame: React.CSSProperties = {
  display: "flex",
  width: "100%",
  flexDirection: "column",
  alignItems: "center",
...
const bebasTitle: React.CSSProperties = {
  color: "#000",
...
const bebasTitleLower: React.CSSProperties = {
  ...bebasTitle,
  marginTop: "5px",
};
const thaiSubtitle: React.CSSProperties = {
  alignSelf: "stretch",
  color: "#FFF",
...
const formFrame: React.CSSProperties = {
  display: "flex",
  flexDirection: "column",
  gap: "10px",
  alignSelf: "stretch",
...
const inputGroupFrame: React.CSSProperties = {
  display: "flex",
  flexDirection: "column",
  gap: "3px",
  alignSelf: "stretch",
...
const buttonGroupFrame: React.CSSProperties = {
  display: "flex",
  flexDirection: "column",
  gap: "10px",
  alignSelf: "stretch",
...
const loginText: React.CSSProperties = {
  color: "#FFF",
  fontFamily: "var(--font-noto-looped)",
  fontSize: "12px",
  fontWeight: 300,
...
const dividerLine: React.CSSProperties = {
  flex: 1,
  height: "1px",
  background: "rgba(205, 219, 243, 0.25)",
};
...
const guestBtn: React.CSSProperties = {
  display: "flex",
  height: "38px",
  justifyContent: "center",
  alignItems: "center",
...
const guestText: React.CSSProperties = {
  color: "#000",
  fontSize: "12px",
  fontWeight: 400,
};
...
const footerBlackText: React.CSSProperties = {
  color: "#000",
  fontSize: "11px",
  fontWeight: 300,
};
const footerWhiteText: React.CSSProperties = {
  color: "#FFF",
  fontSize: "11px",
  fontWeight: 300,
